        ...
        <div className="relative mt-14 space-y-8 pl-8 sm:pl-10">
          ...
          {experience.map((item, i) => (
            <Reveal key={item.company} delay={i * 100} className="relative">
              ...
              <div className="rounded-md border border-border bg-surface p-6 transition-all duration-300 hover:-translate-y-0.5 hover:border-accent/50 hover:shadow-lg hover:shadow-accent/5">
